...
class DetailViewModelTests: XCTestCase {
    ...
    func testDetailViewModelItemsForDetailsForPlanets() {
        XCTAssertEqual(viewModel.items.count, DetailDisplayFields.getDisplayFields(type: .planets).count,
                       "Displayfields Items should have some values to display for planets")
