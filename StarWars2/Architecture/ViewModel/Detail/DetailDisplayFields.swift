...
extension DetailDisplayFields {
    ...
    private static func getPlanetsDetailDisplayFields() -> [DetailDisplayFields] {
        [DetailDisplayFields.name, DetailDisplayFields.population, DetailDisplayFields.orbitalPeriod,
         DetailDisplayFields.rotationPeriod, DetailDisplayFields.climate, DetailDisplayFields.diameter,
         DetailDisplayFields.gravity, DetailDisplayFields.surfaceWater, DetailDisplayFields.terrain,
         DetailDisplayFields.films, DetailDisplayFields.residents, DetailDisplayFields.created,
         DetailDisplayFields.edited]
    }
}
